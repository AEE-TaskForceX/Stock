...
/*--------------------------------------------------AFFICHER----------------------------------------------------------------------------------*/	    
    ...
    public void viewAbonnee() {
		...
		idcolumn.setCellValueFactory(new PropertyValueFactory<Fournisseur, String>("id_client"));
    	...
    	emailcolumn.setCellValueFactory(new PropertyValueFactory<Fournisseur, String>("email"));
