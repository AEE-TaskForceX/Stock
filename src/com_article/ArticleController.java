...
public class ArticleController implements Initializable {
    ...
    void getSelected (MouseEvent event) {
    	...
    	if (index<=-1) {
    		...
    		String some = col_date.getCellData(index).toString();
   		LocalDate datee = LocalDate.parse(some,formater);
   	   i=col_id.getCellData(index).toString();   
       combocat.setValue(col_cat.getCellData(index).toString());
       combofourn.setValue(col_fourn.getCellData(index).toString());
       datefield.setValue(datee);
       txtprix.setText(col_prix.getCellData(index).toString());
       txtref.setText(col_ref.getCellData(index).toString());
    
       txtquant.setText(col_quant.getCellData(index).toString());


    
       txtdet.setText(col_desc.getCellData(index).toString());
